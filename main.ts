...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Loot, function (sprite7, otherSprite2) {
    info.changeScoreBy(1000)
    Chest.destroy(effects.halo, 500)
})
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    Something_you_shoot = sprites.createProjectileFromSprite(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . 1 1 5 . . . . . . 
        . . . . . . 1 5 . 5 5 . . . . . 
...
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`myTile`, function (sprite2, location2) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Boss, function (sprite11, otherSprite5) {
    info.changeLifeBy(-3)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardLava1, function (sprite6, location5) {
    game.over(false, effects.dissolve)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleRedCrystal, function (sprite8, location6) {
    info.setLife(150)
})
info.onCountdownEnd(function () {
    statusbar1.value += 100
    tiles.placeOnRandomTile(Broooooooo_guyyyyyyyyyy, sprites.dungeon.collectibleInsignia)
})
...
function startlevel () {
    if (Current_level == 1) {
        ...
        Veeeeeeeeryyyyyy_baaaad_broooo = sprites.create(img`
            ...
            ......ce7777ec..........
            `, SpriteKind.Boss)
        tiles.placeOnRandomTile(Veeeeeeeeryyyyyy_baaaad_broooo, assets.tile`myTile1`)
        Veeeeeeeeryyyyyy_baaaad_broooo.follow(Broooooooo_guyyyyyyyyyy, 10)
    }
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite10, otherSprite4) {
    info.changeLifeBy(-0.01)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite9, otherSprite3) {
    Baaaaaaaaaaaad_brooooooooooooooo.destroy(effects.disintegrate, 500)
    info.changeScoreBy(50)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleBlueCrystal, function (sprite5, location4) {
    Current_level += 1
    startlevel()
})
function energy_and_health () {
    statusbar1 = statusbars.create(20, 4, StatusBarKind.Energy)
    statusbar1.attachToSprite(Broooooooo_guyyyyyyyyyy)
    statusbar1.setColor(5, 15)
    statusbar1.setLabel("SL")
}
statusbars.onZero(StatusBarKind.Energy, function (status) {
    info.startCountdown(5)
    Broooooooo_guyyyyyyyyyy.x = 0
})
let Veeeeeeeeryyyyyy_baaaad_broooo: Sprite = null
let statusbar1: StatusBarSprite = null
let Something_you_shoot: Sprite = null
let Batyyyyyyyyy: Sprite = null
let Baaaaaaaaaaaad_brooooooooooooooo: Sprite = null
let Chest: Sprite = null
let Broooooooo_guyyyyyyyyyy: Sprite = null
let Current_level = 0
Current_level = 1
Broooooooo_guyyyyyyyyyy = sprites.create(img`
    ...
    . . . . . . . f f f . . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(Broooooooo_guyyyyyyyyyy, 100, 0)
Broooooooo_guyyyyyyyyyy.ay = 200
scene.cameraFollowSprite(Broooooooo_guyyyyyyyyyy)
startlevel()
energy_and_health()
for (let value of sprites.allOfKind(SpriteKind.Loot)) {
    value.destroy()
}
...
Baaaaaaaaaaaad_brooooooooooooooo = sprites.create(img`
    ...
    `, SpriteKind.Enemy)
animation.runImageAnimation(
Baaaaaaaaaaaad_brooooooooooooooo,
[img`
    ........................
    ........................
    ........................
...
for (let value3 of tiles.getTilesByType(sprites.dungeon.hazardLava1)) {
    Batyyyyyyyyy = sprites.create(img`
        ...
        . . . . . . . . . . . . . 4 2 . 
        `, SpriteKind.Enemy)
    tiles.placeOnTile(Batyyyyyyyyy, value3)
    tiles.setTileAt(value3, sprites.dungeon.hazardLava1)
    ...
    Batyyyyyyyyy.startEffect(effects.fire)
}
...
game.onUpdate(function () {
    if (Broooooooo_guyyyyyyyyyy.isHittingTile(CollisionDirection.Left) || Broooooooo_guyyyyyyyyyy.isHittingTile(CollisionDirection.Right) && Broooooooo_guyyyyyyyyyy.vy >= 0) {
        Broooooooo_guyyyyyyyyyy.vy = 0
        Broooooooo_guyyyyyyyyyy.ay = 0
        Broooooooo_guyyyyyyyyyy.setImage(img`
            . . . . . . f f f f f f . . . . . 
            . . . . f f 1 1 1 1 f 1 f . . . . 
    ...
    if (Broooooooo_guyyyyyyyyyy.isHittingTile(CollisionDirection.Left)) {
        Broooooooo_guyyyyyyyyyy.image.flipX()
        Broooooooo_guyyyyyyyyyy.setImage(Broooooooo_guyyyyyyyyyy.image)
    }
})
